...
install: ~pthon3 -m pip install epc orjson sexpdata six paramiko ruff-lsp packaging~
...
(use-package emigo
  ...
  (setq emigo-api-key openrouter-api-key)
  (setq emigo-window-width 80))
#+end_src
