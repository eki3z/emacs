...
#+begin_src emacs-lisp :lexical t
(define-derived-mode web-vue-mdoe web-mode "wVue"
...
(use-package org-capture
  ...
  (setq org-capture-templates
        `(("i" "Idea" entry (file ,(concat org-directory "/idea.org"))
          ...
          ("d" "Diary" item (file+olp+datetree ,(concat org-directory "/diary.org"))
           "- %i%?" :time-prompt t :immediate-finish t :empty-lines 1))))
#+end_src
